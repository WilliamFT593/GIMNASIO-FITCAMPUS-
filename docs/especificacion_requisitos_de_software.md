...
| **Requisitos Relacionados** | RF-001 (Control de aforo en tiempo real)<br>RF-002 (Registro automático de entradas/salidas)<br>RF-003 (Gestión de filas virtuales)<br>RF-004 (Notificaciones de aforo máximo)
<br>RF-005 (Bloqueo automático de acceso)<br>RNF-001 (Tiempo de respuesta < 2 segundos)<br>RNF-002 (Precisión de conteo > 98%)<br>RNF-003 (Disponibilidad 99.5%) |
